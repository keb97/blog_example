...
class DiscussionsControllerTest < ActionController::TestCase
  ...
  test "should create discussion" do
    assert_difference('Discussion.count') do
      post :create, discussion: { article_id: @discussion.article_id, comment: @discussion.comment, user_id: @discussion.user_id }
    end
  ...
  test "should update discussion" do
    patch :update, id: @discussion, discussion: { article_id: @discussion.article_id, comment: @discussion.comment, user_id: @discussion.user_id }
    assert_redirected_to discussion_path(assigns(:discussion))
  end
